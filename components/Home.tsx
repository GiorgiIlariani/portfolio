    ...
    >
      ...
      >
        ...
        <h1 className="sm:text-[40px] text-6xl font-bold text-[#ccd6f6]">
          <TypeAnimation
            sequence={["Giorgi Ilariani", 1000, "Next.js Developer", 1000]}
            wrapper="span"
            speed={50}
            repeat={Infinity}
          />
        ...
        <p className="text-[#8892b0] py-4 max-w-[700px] mt-2 text-xl">
          <TypeAnimation
            sequence={[
              "Building modern, fast, and scalable web apps using Next.js, React, and TypeScript with strong focus on clean UI and great user experience.",
              1000,
            ]}
            wrapper="span"
            speed={70}
